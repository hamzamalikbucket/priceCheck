import 'package:compareapp/Models/event_model.dart';
import 'package:compareapp/modules/screens/HostDetails/Events/host_event_details.dart';
...
class EventByLocationScreen extends StatefulWidget {
  const EventByLocationScreen({super.key});
...
class EventState extends State<EventByLocationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: ToolbarBack(appBar: AppBar(), title: ""),
      body: SafeArea(
        child: Column(
                  ...
                  return GestureDetector(
                    onTap:(){
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const HostEventsDetails(),
