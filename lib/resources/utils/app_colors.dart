...
class AppColors {
  ...
  static const lightgreyColor = Color(0xffADA4A5);
  static const containerBg = Color(0xffEFF1F5);

  static const greyTextColor = Color(0xff828282);
  ...
  static const hintGray = Color(0xff68758A);
